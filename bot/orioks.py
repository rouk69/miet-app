...
баллы. Текста самого задания API не отдаёт — только что сдавать и к
какому сроку. Его нет и в веб-версии: в ОРИОКС условие задания просто
не хранится, это проверено на живом аккаунте.

Что есть — файлы, приложенные преподавателем к мероприятию. Они лежат
только в веб-версии, поэтому приезжают из orioks_web и приклеиваются
здесь, в with_materials().
