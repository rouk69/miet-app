...
# Адрес мини-приложения — общий для кнопки меню, клавиатур и утренней
# рассылки. Считает его bot/webapp.py: раньше эта логика жила в трёх
# местах и разъезжалась.
WEBAPP_URL = webapp_watch.app_url()
